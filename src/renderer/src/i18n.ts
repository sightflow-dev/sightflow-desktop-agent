...
const translations = {
  ...
  en: {
    ...
    'control.log.draft': 'Draft',
    'control.log.skip': 'Skip',
    'control.log.error': 'Error',
    'control.replyMode': 'Reply Mode',
    'control.replyMode.draft': 'Safe Draft',
    'control.replyMode.autoSend': 'Auto Send',
    'control.replyMode.draftHint': 'AI fills the input box but does not send automatically.',
    'control.replyMode.autoSendHint': 'AI sends the generated reply automatically.',
